...
//------------------------ req ------------------------
type AddMidConnectionSpecialReqCBD struct {
...
type ListMidConnectionSpecialReqCBD struct {
...
type EditMidConnectionSpecialReqCBD struct {
...
type DelMidConnectionSpecialReqCBD struct {
	ID		uint64		`json:"id"  binding:"required,gte=1"`
}

//--------------------resp-------------------------------
type ListMidConnectionSpecialRespCBD struct {
